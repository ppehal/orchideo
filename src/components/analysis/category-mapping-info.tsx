...
import { getGroupedMappings, INDUSTRIES, type IndustryCode } from '@/lib/constants/fb-category-map'
...
export function CategoryMappingInfo() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">Referenční seznam Facebook kategorií</CardTitle>
        <CardDescription>
