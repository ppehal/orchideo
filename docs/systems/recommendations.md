...
### RecommendationCard Component (Two-Column Layout)

**Since:** 2026-02-04
**Component:** `src/components/report/trigger-detail/recommendation-card.tsx`

Displays detailed trigger recommendations on trigger detail pages with improved UX:
...
- Works automatically across all 25+ triggers without data changes
